 ...
 * @Date: 2019-05-27 11:40:41 
 * @Last Modified by: jiangxiaoxiang
 * @Last Modified time: 2019-05-28 16:16:52
 */
...
const getters: GetterTree<${capPirName}State, any> = {
  ${dirName}: (state: ${capPirName}State) => state.${dirName}
}
...
// api 接口模版
// const apiTep = `import Api from '@/api/requestConfig/request'
